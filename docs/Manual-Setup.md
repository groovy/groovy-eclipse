...
Groovy-Eclipse is intended to be developed using Eclipse. Download and install [the "Eclipse IDE for Eclipse Committers" package](https://eclipse.org/downloads/packages/release/2026-03/r/eclipse-ide-eclipse-committers) for your operating system.
