...
import org.codehaus.groovy.eclipse.dsl.earlystartup.InitializeAllGDSLs;
...
public class DSLPreferencesPage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    class Adapter implements ITreeListAdapter {
        ...
        public Object[] getChildren(TreeListDialogField field, Object element) {
            if (element instanceof String) {
                ...
                if (project != null) {
                    ContextStore store = manager.getContextStore(project);
                    if (store != null) {
    ...
    private final ContextStoreManager manager;

    private IWorkbenchPage page;
    
    public DSLPreferencesPage() {
        manager = GroovyDSLActivator.getDefault().getContextStoreManager();
    }
        ...
        if (canEdit()) {
            ...
            if (file.isAccessible()) {
                ...
                ErrorDialog.openError(page.getWorkbenchWindow().getShell(), "Could not open editor", "File " + pck.dslFileName
                        + " is not accessible.", new Status(IStatus.ERROR, GroovyDSLActivator.PLUGIN_ID, "Could not open editor"));
            }
        }
    }
    ...
    protected void recompile() {
        new InitializeAllGDSLs().initializeAll();
    }
}
