...
class GroovyProposalTypeSearchRequestor implements ISearchRequestor {
    ...
    public GroovyProposalTypeSearchRequestor(int offset, int replaceLength, int actualCompletionPosition,
            JavaContentAssistInvocationContext javaContext, NameLookup nameLookup, IProgressMonitor monitor) {
        this.offset = offset;
        this.javaContext = javaContext;
        this.module = GeneralGroovyCompletionProcessor.getCurrentModuleNode(javaContext);
    ...
    private ICompletionProposal proposeType(char[] packageName,
        ...
        ReflectionUtils.setPrivateField(InternalCompletionProposal.class, "nameLookup", proposal, nameLookup);
        ReflectionUtils.setPrivateField(InternalCompletionProposal.class, "packageName", proposal, packageName);
        ReflectionUtils.setPrivateField(InternalCompletionProposal.class, "typeName", proposal, simpleTypeName);
        ReflectionUtils.setPrivateField(InternalCompletionProposal.class, "accessibility", proposal, accessibility);
