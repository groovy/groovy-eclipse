...
public class GroovyParticipantExtensionPoint {
	 ...
	 */
	public GroovyParticipantExtensionPoint(String pluginId, String participantId, Class clazz) {
	 ...
	 */
	public RefactoringParticipant[] getParticipants(RefactoringStatus status, RefactoringProcessor processor, Object element, RefactoringArguments arguments, IParticipantDescriptorFilter filter, String[] affectedNatures, GroovySharableParticipants shared) {
		if (fParticipants == null)
			init();

		EvaluationContext evalContext= createEvaluationContext(element, affectedNatures);
