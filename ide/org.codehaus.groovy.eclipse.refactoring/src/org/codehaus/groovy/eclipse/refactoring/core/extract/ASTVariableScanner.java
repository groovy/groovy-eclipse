...
public class ASTVariableScanner {
    ...
    private class DefaultVisit extends ASTVisitorDecorator<ASTVariableScanner> {
        ...
        public void visitPostfixExpression(PostfixExpression expression) {
            expression.getExpression().visit(new DefaultAssignementVisit(container, expression.getOperation()));
        }
    ...
    private class RepeatableBlockVisit extends InnerBlockVisit {
        ...
        public void visitBinaryExpression(BinaryExpression expression) {
            expression.getLeftExpression()
                .visit(new AssignmentInRepeatableBlockVisit(container, expression.getOperation()));
    ...
    private class ClosureVisit extends RepeatableBlockVisit {
        ...
        @Override
        public void visitPostfixExpression(PostfixExpression expression) {
            expression.getExpression().visit(new AssignementInClosureVisit(container, expression.getOperation()));
        }
