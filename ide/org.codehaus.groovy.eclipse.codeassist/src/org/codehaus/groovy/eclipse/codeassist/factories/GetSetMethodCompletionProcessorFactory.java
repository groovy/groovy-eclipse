...
import org.codehaus.groovy.eclipse.codeassist.processors.GetSetMethodCompletionProcessor;
...
public class GetSetMethodCompletionProcessorFactory implements IGroovyCompletionProcessorFactory {
    @Override
    public IGroovyCompletionProcessor createProcessor(ContentAssistContext context, JavaContentAssistInvocationContext javaContext, SearchableEnvironment nameEnvironment) {
        return new GetSetMethodCompletionProcessor(context, javaContext, nameEnvironment);
    }
}
