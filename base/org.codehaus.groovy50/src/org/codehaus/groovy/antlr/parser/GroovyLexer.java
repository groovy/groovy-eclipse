...
public GroovyLexer(LexerSharedInputState state) {
    ...
    literals.put(new ANTLRHashString("byte", this), Integer.valueOf(106));
    literals.put(new ANTLRHashString("public", this), Integer.valueOf(116));
    literals.put(new ANTLRHashString("trait", this), Integer.valueOf(95));
    literals.put(new ANTLRHashString("case", this), Integer.valueOf(150));
    literals.put(new ANTLRHashString("short", this), Integer.valueOf(108));
    literals.put(new ANTLRHashString("break", this), Integer.valueOf(144));
    literals.put(new ANTLRHashString("while", this), Integer.valueOf(139));
    literals.put(new ANTLRHashString("new", this), Integer.valueOf(159));
    literals.put(new ANTLRHashString("instanceof", this), Integer.valueOf(158));
    literals.put(new ANTLRHashString("implements", this), Integer.valueOf(131));
    literals.put(new ANTLRHashString("synchronized", this), Integer.valueOf(121));
    literals.put(new ANTLRHashString("const", this), Integer.valueOf(41));
    literals.put(new ANTLRHashString("float", this), Integer.valueOf(110));
    literals.put(new ANTLRHashString("package", this), Integer.valueOf(81));
    literals.put(new ANTLRHashString("return", this), Integer.valueOf(143));
    literals.put(new ANTLRHashString("throw", this), Integer.valueOf(146));
    literals.put(new ANTLRHashString("null", this), Integer.valueOf(160));
    literals.put(new ANTLRHashString("def", this), Integer.valueOf(84));
    literals.put(new ANTLRHashString("threadsafe", this), Integer.valueOf(120));
    literals.put(new ANTLRHashString("protected", this), Integer.valueOf(117));
    literals.put(new ANTLRHashString("class", this), Integer.valueOf(92));
    literals.put(new ANTLRHashString("throws", this), Integer.valueOf(130));
    literals.put(new ANTLRHashString("do", this), Integer.valueOf(42));
    literals.put(new ANTLRHashString("strictfp", this), Integer.valueOf(43));
    literals.put(new ANTLRHashString("super", this), Integer.valueOf(99));
    literals.put(new ANTLRHashString("transient", this), Integer.valueOf(118));
    literals.put(new ANTLRHashString("native", this), Integer.valueOf(119));
    literals.put(new ANTLRHashString("interface", this), Integer.valueOf(93));
    literals.put(new ANTLRHashString("final", this), Integer.valueOf(38));
    literals.put(new ANTLRHashString("if", this), Integer.valueOf(137));
    literals.put(new ANTLRHashString("double", this), Integer.valueOf(112));
    literals.put(new ANTLRHashString("volatile", this), Integer.valueOf(122));
    literals.put(new ANTLRHashString("as", this), Integer.valueOf(114));
    literals.put(new ANTLRHashString("assert", this), Integer.valueOf(147));
    literals.put(new ANTLRHashString("catch", this), Integer.valueOf(153));
    literals.put(new ANTLRHashString("try", this), Integer.valueOf(151));
    literals.put(new ANTLRHashString("goto", this), Integer.valueOf(40));
    literals.put(new ANTLRHashString("enum", this), Integer.valueOf(94));
    literals.put(new ANTLRHashString("int", this), Integer.valueOf(109));
    literals.put(new ANTLRHashString("for", this), Integer.valueOf(141));
    literals.put(new ANTLRHashString("extends", this), Integer.valueOf(98));
    literals.put(new ANTLRHashString("boolean", this), Integer.valueOf(105));
    literals.put(new ANTLRHashString("char", this), Integer.valueOf(107));
    literals.put(new ANTLRHashString("private", this), Integer.valueOf(115));
    literals.put(new ANTLRHashString("default", this), Integer.valueOf(129));
    literals.put(new ANTLRHashString("false", this), Integer.valueOf(157));
    literals.put(new ANTLRHashString("this", this), Integer.valueOf(132));
    literals.put(new ANTLRHashString("static", this), Integer.valueOf(83));
    literals.put(new ANTLRHashString("abstract", this), Integer.valueOf(39));
    literals.put(new ANTLRHashString("continue", this), Integer.valueOf(145));
    literals.put(new ANTLRHashString("finally", this), Integer.valueOf(152));
    literals.put(new ANTLRHashString("else", this), Integer.valueOf(138));
    literals.put(new ANTLRHashString("import", this), Integer.valueOf(82));
    literals.put(new ANTLRHashString("in", this), Integer.valueOf(142));
    literals.put(new ANTLRHashString("void", this), Integer.valueOf(104));
    literals.put(new ANTLRHashString("switch", this), Integer.valueOf(140));
    literals.put(new ANTLRHashString("true", this), Integer.valueOf(161));
    literals.put(new ANTLRHashString("long", this), Integer.valueOf(111));
}
            ...
            case 'u':
            {
                ...
                do {
                    if ((LA(1)=='u')) {
                        ...
                        if ( _cnt765>=1 ) { break _loop765; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
                    }
...
inputState.guessing--;
    ...
    public final void mREGEXP_LITERAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (((LA(1)=='/') && (_tokenSet_6.member(LA(2))) && (true) && (true))&&(allowRegexpLiteral())) {
            ...
            boolean synPredMatched735 = false;
            if (((LA(1)=='/') && (true))) {
                int _m735 = mark();
...
inputState.guessing--;
            ...
            if ( synPredMatched749 ) {
                ...
                boolean synPredMatched751 = false;
                if (((LA(1)=='$') && (LA(2)=='$') && ((LA(3) >= '\u0000' && LA(3) <= '\ufffe')) && (true))) {
                    int _m751 = mark();
