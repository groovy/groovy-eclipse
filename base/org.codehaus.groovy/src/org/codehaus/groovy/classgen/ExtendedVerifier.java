...
public class ExtendedVerifier implements GroovyClassVisitor {
    ...
    protected void visitAnnotations(AnnotatedNode node, int target) {
        ...
        for (Iterator it = annotations.iterator(); it.hasNext();) {
            ...
            // Use the name as that is more reliable in the case where the node is something other than from a .class
            boolean isTargetAnnotation = "java.lang.annotation.Target".equals(annotation.getClassNode().getName());
