...
public class ASTNode {
    ...
    private ListHashMap metaDataMap = null;  // GRECLIPSE save space if not using this field 
    ...
    public Object getNodeMetaData(Object key) {
        return metaDataMap == null ? null : metaDataMap.get(key);  // GRECLIPSE
    }
