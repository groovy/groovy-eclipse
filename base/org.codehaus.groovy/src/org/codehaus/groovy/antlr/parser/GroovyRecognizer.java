...
/** A formal parameter for a method or closure. */
	public final void parameterDeclaration() throws RecognitionException, TokenStreamException {
		...
		{
		if ((_tokenSet_25.member(LA(1))) && (_tokenSet_70.member(LA(2)))) {
			typeSpec(false);
			t_AST = (AST)returnAST;
		}
		else if ((LA(1)==IDENT||LA(1)==TRIPLE_DOT) && (_tokenSet_71.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
inputState.guessing--;
		...
		{
		if (((_tokenSet_75.member(LA(1))) && (_tokenSet_76.member(LA(2))))&&(isPathExpr)) {
...
inputState.guessing--;
		...
		else if ((_tokenSet_87.member(LA(1))) && (_tokenSet_76.member(LA(2)))) {
			{
			switch ( LA(1)) {
			case FINAL:
			case ABSTRACT:
...
inputState.guessing--;
		...
		else if ((_tokenSet_20.member(LA(1))) && (_tokenSet_76.member(LA(2)))) {
			expression(0);
			astFactory.addASTChild(currentAST, returnAST);
			commandArgument_AST = (AST)currentAST.root;
		}
...
inputState.guessing--;
		...
		if ( synPredMatched525 ) {
			...
			if (((_tokenSet_90.member(LA(1))) && (LA(2)==COLON))) {
				int _m527 = mark();
...
inputState.guessing--;
			...
			else if ((_tokenSet_91.member(LA(1))) && (_tokenSet_89.member(LA(2)))) {
				primaryExpression();
				astFactory.addASTChild(currentAST, returnAST);
				argumentLabel_AST = (AST)currentAST.root;
			}
 ...
 */
	...
	public final void relationalExpression(
		...
		astFactory.addASTChild(currentAST, returnAST);
		{
		if ((_tokenSet_98.member(LA(1))) && (_tokenSet_82.member(LA(2)))) {
			{
			{
			switch ( LA(1)) {
			case LT:
		...
		else if ((LA(1)==LITERAL_instanceof) && (_tokenSet_99.member(LA(2)))) {
			AST tmp307_AST = null;
		...
		else if ((LA(1)==LITERAL_as) && (_tokenSet_99.member(LA(2)))) {
			AST tmp308_AST = null;
		...
		else if ((_tokenSet_100.member(LA(1))) && (_tokenSet_74.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
inputState.guessing--;
	...
	public final void postfixExpression(
		...
		astFactory.addASTChild(currentAST, returnAST);
		{
		if ((LA(1)==INC) && (_tokenSet_102.member(LA(2)))) {
			in = LT(1);
		...
		else if ((LA(1)==DEC) && (_tokenSet_102.member(LA(2)))) {
			de = LT(1);
		...
		else if ((_tokenSet_102.member(LA(1))) && (_tokenSet_74.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
	...
	public final void newExpression() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case NLS:
			{
				...
				else if ((_tokenSet_95.member(LA(1))) && (_tokenSet_74.member(LA(2)))) {
				}
				else {
					throw new NoViableAltException(LT(1), getFilename());
				}
 ...
 */
	public final void listOrMapConstructorExpression() throws RecognitionException, TokenStreamException {
		...
		if ((LA(1)==LBRACK) && (_tokenSet_103.member(LA(2)))) {
			lcon = LT(1);
...
inputState.guessing--;
		...
		else if ((_tokenSet_84.member(LA(1))) && (_tokenSet_105.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
