...
public GroovyLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("new", this), new Integer(155));
	literals.put(new ANTLRHashString("instanceof", this), new Integer(154));
	...
	literals.put(new ANTLRHashString("false", this), new Integer(153));
			...
			case 'u':
			{
				...
				do {
					if ((LA(1)=='u')) {
						...
						if ( _cnt665>=1 ) { break _loop665; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
...
inputState.guessing--;
	...
	public final void mREGEXP_LITERAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if (((LA(1)=='/') && (_tokenSet_6.member(LA(2))) && (true) && (true))&&(allowRegexpLiteral())) {
			...
			{
			if (((LA(1)=='$') && (_tokenSet_2.member(LA(2))))&&(!atValidDollarEscape())) {
				match('$');
	...
	protected final void mREGEXP_SYMBOL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		else if (((LA(1)=='\\') && (_tokenSet_1.member(LA(2))) && (true) && (true))&&( LA(2)!='/' && LA(2)!='\n' && LA(2)!='\r' )) {
			match('\\');
		}
		else if ((LA(1)=='\\') && (LA(2)=='\n'||LA(2)=='\r')) {
			_saveIndex=text.length();
					...
					try {
						...
						do {
							if (((LA(1) >= '0' && LA(1) <= '9'))) {
								...
								if ( _cnt690>=1 ) { break _loop690; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
							}
				...
				if ( synPredMatched693 ) {
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '9'))) {
							...
							if ( _cnt695>=1 ) { break _loop695; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
					...
					case '.':
					{
						...
						do {
							if (((LA(1) >= '0' && LA(1) <= '9'))) {
								...
								if ( _cnt709>=1 ) { break _loop709; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
							}
	...
	protected final void mEXPONENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt718>=1 ) { break _loop718; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
