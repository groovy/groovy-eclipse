...
public class InvocationWriter {
    ...
    protected boolean writeDirectMethodCall(final MethodNode target, final boolean implicitThis, final Expression receiver, final TupleExpression args) {
        ...
        if (target.isStatic()) {
            opcode = INVOKESTATIC;
        /* GRECLIPSE edit -- GROOVY-8693, et al.
        ...
        /* GRECLIPSE edit -- GROOVY-8693, GROOVY-10380
        ...
        */
        mv.visitMethodInsn(opcode, BytecodeHelper.getClassInternalName(ownerClass), methodName, descriptor, ownerClass.isInterface());
        // GRECLIPSE end
