...
public interface GroovyTokenTypes {
	...
	int EQUAL = 178;
	int IDENTICAL = 179;
	int NOT_IDENTICAL = 180;
	int COMPARE_TO = 181;
	int LE = 182;
	int GE = 183;
	int SL = 184;
	int RANGE_INCLUSIVE = 185;
	int RANGE_EXCLUSIVE = 186;
	int INC = 187;
	int DIV = 188;
	int MOD = 189;
	int DEC = 190;
	...
	int BNOT = 192;
	int LNOT = 193;
	int STRING_CTOR_START = 194;
	int STRING_CTOR_END = 195;
	int NUM_INT = 196;
	int NUM_FLOAT = 197;
	int NUM_LONG = 198;
	int NUM_DOUBLE = 199;
	...
	int ML_COMMENT = 207;
	int STRING_CH = 208;
	int REGEXP_LITERAL = 209;
	int DOLLAR_REGEXP_LITERAL = 210;
	int REGEXP_CTOR_END = 211;
	int DOLLAR_REGEXP_CTOR_END = 212;
	int ESCAPED_SLASH = 213;
	int ESCAPED_DOLLAR = 214;
	int REGEXP_SYMBOL = 215;
	int DOLLAR_REGEXP_SYMBOL = 216;
	int ESC = 217;
	int STRING_NL = 218;
	int HEX_DIGIT = 219;
	int VOCAB = 220;
