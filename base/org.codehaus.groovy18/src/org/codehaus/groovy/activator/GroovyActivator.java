...
public class GroovyActivator extends Plugin {
    ...
    public static final String GROOVY_ALL_JAR = "lib/groovy-all-1.8.0-rc-2.jar"; //$NON-NLS-1$
    public static final String GROOVY_JAR = "lib/groovy-1.8.0-rc-2.jar"; //$NON-NLS-1$
