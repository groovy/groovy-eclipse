...
public class TryCatchStatement extends Statement {
    ...
    // GRECLIPSE add
    public TryCatchStatement addResource$$bridge(ExpressionStatement resourceStatement) {
    ...
    public static boolean isResource(Expression expression) {
        ...
        return null != r && r;
        */
        return Boolean.TRUE.equals(expression.getNodeMetaData(IS_RESOURCE));
        // GRECLIPSE end
    }
    ...
    // GRECLIPSE add
    public TryCatchStatement addCatch$$bridge(CatchStatement catchStatement) {
