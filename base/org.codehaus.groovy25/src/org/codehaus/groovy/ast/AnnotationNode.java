...
public class AnnotationNode extends ASTNode {
    ...
    private final ClassNode classNode; // GRECLIPSE edit -- retain insertion order:
    private final Map<String, Expression> members = new LinkedHashMap<String, Expression>();
