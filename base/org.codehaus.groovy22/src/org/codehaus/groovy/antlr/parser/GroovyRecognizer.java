...
/** A block body is a parade of zero or more statements or expressions. */
	...
	public final void interfaceDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			interfaceDefinition_AST = (AST)astFactory.make( (new ASTArray(6)).add(create(INTERFACE_DEF,"INTERFACE_DEF",first,LT(1))).add(modifiers).add(tmp35_AST).add(tp_AST).add(ie_AST).add(ib_AST));
	...
	public final void enumDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			enumDefinition_AST = (AST)astFactory.make( (new ASTArray(5)).add(create(ENUM_DEF,"ENUM_DEF",first,LT(1))).add(modifiers).add(tmp37_AST).add(ic_AST).add(eb_AST));
	...
	public final void annotationDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			annotationDefinition_AST = (AST)astFactory.make( (new ASTArray(4)).add(create(ANNOTATION_DEF,"ANNOTATION_DEF",first,LT(1))).add(modifiers).add(tmp40_AST).add(ab_AST));
...
inputState.guessing--;
	...
	public final void modifiersInternal() throws RecognitionException, TokenStreamException {
		...
		do {
			...
			else if ((LA(1)==AT) && (_tokenSet_48.member(LA(2)))) {
				annotation();
				astFactory.addASTChild(currentAST, returnAST);
				nls();
			}
	...
	public final void annotationArguments() throws RecognitionException, TokenStreamException {
		...
		else if ((_tokenSet_51.member(LA(1))) && (LA(2)==ASSIGN)) {
	...
	public final void annotationsInternal() throws RecognitionException, TokenStreamException {
		...
		do {
			...
			else if ((LA(1)==AT) && (_tokenSet_52.member(LA(2)))) {
				annotation();
				astFactory.addASTChild(currentAST, returnAST);
				nls();
			}
	...
	public final void enumBlock() throws RecognitionException, TokenStreamException {
		...
		if (((LA(1)==IDENT||LA(1)==AT) && (_tokenSet_53.member(LA(2))))) {
			int _m139 = mark();
...
inputState.guessing--;
	...
	public final void typeParameter() throws RecognitionException, TokenStreamException {
		...
		else if ((_tokenSet_56.member(LA(1))) && (_tokenSet_12.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
inputState.guessing--;
			...
			else if ((LA(1)==IDENT||LA(1)==STRING_LITERAL) && (_tokenSet_59.member(LA(2)))) {
...
inputState.guessing--;
			...
			else if ((LA(1)==COMMA||LA(1)==NLS) && (_tokenSet_62.member(LA(2)))) {
				nls();
				match(COMMA);
				{
...
inputState.guessing--;
				...
				if ( synPredMatched155 ) {
					...
					if (((_tokenSet_63.member(LA(1))) && (_tokenSet_53.member(LA(2))))) {
						int _m157 = mark();
...
inputState.guessing--;
			...
			if ( synPredMatched176 ) {
				...
				if (((_tokenSet_13.member(LA(1))) && (_tokenSet_64.member(LA(2))))) {
					int _m178 = mark();
...
inputState.guessing--;
				...
				else if ((_tokenSet_65.member(LA(1))) && (_tokenSet_17.member(LA(2)))) {
					modifiersOpt();
...
inputState.guessing--;
			...
			if ( inputState.guessing==0 ) {
				...
				enumConstantFieldInternal_AST = (AST)astFactory.make( (new ASTArray(7)).add(create(METHOD_DEF,"METHOD_DEF",first,LT(1))).add(mods).add((AST)astFactory.make( (new ASTArray(2)).add(create(TYPE,"TYPE",first,LT(1))).add(t))).add(tmp179_AST).add(param_AST).add(tc_AST).add(s2_AST));
				if (tp != null) {
...
inputState.guessing--;
		...
		else if ((LA(1)==LCURLY||LA(1)==NLS) && (_tokenSet_68.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
inputState.guessing--;
		...
		else if ((_tokenSet_31.member(LA(1))) && (_tokenSet_71.member(LA(2)))) {
			blockBody(EOF);
 ...
 */
	public final void nlsWarn() throws RecognitionException, TokenStreamException {
		...
		if (((_tokenSet_72.member(LA(1))) && (_tokenSet_2.member(LA(2))))) {
			int _m594 = mark();
...
inputState.guessing--;
		...
		else if ((_tokenSet_72.member(LA(1))) && (_tokenSet_2.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
/** An open block is not allowed to have closure arguments. */
	...
	public final void expressionStatementNoCheck() throws RecognitionException, TokenStreamException {
		...
		{
		if (((_tokenSet_73.member(LA(1))) && (_tokenSet_74.member(LA(2))))&&(LA(1)!=LITERAL_else && isPathExpr /*&& #head.getType()==METHOD_CALL*/)) {
...
/** A formal parameter for a method or closure. */
	public final void parameterDeclaration() throws RecognitionException, TokenStreamException {
		...
		{
		if ((_tokenSet_25.member(LA(1))) && (_tokenSet_75.member(LA(2)))) {
			typeSpec(false);
			t_AST = (AST)returnAST;
		}
		else if ((LA(1)==IDENT||LA(1)==TRIPLE_DOT) && (_tokenSet_76.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
	...
	public final void multicatch() throws RecognitionException, TokenStreamException {
		...
		{
		if ((LA(1)==IDENT||LA(1)==NLS) && (_tokenSet_77.member(LA(2)))) {
			multicatch_types();
			m_AST = (AST)returnAST;
			astFactory.addASTChild(currentAST, returnAST);
		}
...
inputState.guessing--;
		...
		else if (((_tokenSet_31.member(LA(1))) && (_tokenSet_74.member(LA(2))))&&(addImplicit)) {
			implicitParameters();
			astFactory.addASTChild(currentAST, returnAST);
			closableBlockParamsOpt_AST = (AST)currentAST.root;
		}
...
inputState.guessing--;
		...
		else if ((_tokenSet_16.member(LA(1))) && (_tokenSet_82.member(LA(2)))) {
			forInClause();
 ...
 */
	public final boolean  strictContextExpression(
		...
		if (((_tokenSet_16.member(LA(1))) && (_tokenSet_83.member(LA(2))))) {
			int _m528 = mark();
...
inputState.guessing--;
		...
		else if ((LA(1)==AT) && (_tokenSet_84.member(LA(2)))) {
			annotation();
			astFactory.addASTChild(currentAST, returnAST);
		}
		else {
	...
	public final void tryBlock() throws RecognitionException, TokenStreamException {
		...
		{
		if ((LA(1)==LITERAL_finally||LA(1)==NLS) && (_tokenSet_85.member(LA(2)))) {
			nls();
			finallyClause();
 ...
 */
	public final void branchStatement() throws RecognitionException, TokenStreamException {
		...
		case LITERAL_assert:
		{
			...
			{
			if ((LA(1)==COMMA||LA(1)==COLON) && (_tokenSet_86.member(LA(2)))) {
				{
				switch ( LA(1)) {
				case COMMA:
				{
			...
			else if ((_tokenSet_87.member(LA(1))) && (_tokenSet_12.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
	...
	public final void closureList() throws RecognitionException, TokenStreamException {
		...
		_loop326:
		do {
			if ((LA(1)==SEMI) && (_tokenSet_88.member(LA(2)))) {
				match(SEMI);
				sce=strictContextExpression(true);
				astFactory.addASTChild(currentAST, returnAST);
			}
...
inputState.guessing--;
	...
	public final void commandArgumentsGreedy(
		...
		if (((_tokenSet_91.member(LA(1))) && (_tokenSet_38.member(LA(2))))) {
			int _m385 = mark();
...
inputState.guessing--;
				...
				else if ((_tokenSet_91.member(LA(1))) && (_tokenSet_38.member(LA(2)))) {
					{
...
inputState.guessing--;
			...
			else if ((_tokenSet_92.member(LA(1))) && (_tokenSet_100.member(LA(2)))) {
				primaryExpression();
				astFactory.addASTChild(currentAST, returnAST);
				argumentLabel_AST = (AST)currentAST.root;
			}
 ...
 */
	...
	public final void relationalExpression(
		...
		astFactory.addASTChild(currentAST, returnAST);
		{
		if ((_tokenSet_104.member(LA(1))) && (_tokenSet_86.member(LA(2)))) {
			{
			{
			switch ( LA(1)) {
			case LT:
		...
		else if ((LA(1)==LITERAL_instanceof) && (_tokenSet_105.member(LA(2)))) {
			AST tmp307_AST = null;
		...
		else if ((LA(1)==LITERAL_as) && (_tokenSet_105.member(LA(2)))) {
			AST tmp308_AST = null;
		...
		else if ((_tokenSet_106.member(LA(1))) && (_tokenSet_74.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
inputState.guessing--;
	...
	public final void postfixExpression(
		...
		astFactory.addASTChild(currentAST, returnAST);
		{
		if ((LA(1)==INC) && (_tokenSet_108.member(LA(2)))) {
			in = LT(1);
		...
		else if ((LA(1)==DEC) && (_tokenSet_108.member(LA(2)))) {
			de = LT(1);
		...
		else if ((_tokenSet_108.member(LA(1))) && (_tokenSet_74.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
	...
	public final void newExpression() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case NLS:
			{
				...
				mca_AST = (AST)returnAST;
				{
				if ((LA(1)==LCURLY) && (_tokenSet_54.member(LA(2)))) {
					classBlock();
					cb_AST = (AST)returnAST;
					astFactory.addASTChild(currentAST, returnAST);
				}
				else if ((_tokenSet_103.member(LA(1))) && (_tokenSet_74.member(LA(2)))) {
				}
				else {
					throw new NoViableAltException(LT(1), getFilename());
				}
...
inputState.guessing--;
		...
		else if ((_tokenSet_88.member(LA(1))) && (_tokenSet_111.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
