...
public class Unicode15_1Test extends AbstractRegressionTest {
public Unicode15_1Test(String name) {
	super(name);
}
...
public void test1() {
	...
	this.runConformTest(
		new String[] {
			"X.java",
			"public class X {\n" +
			"		public int a\\uD87A\\uDFF0; // new unicode character in unicode 15.1 using high and low surrogate\n" +
			"}",
		},
		"",
		options);
...
public static Class<Unicode15_1Test> testClass() {
	return Unicode15_1Test.class;
}
}
