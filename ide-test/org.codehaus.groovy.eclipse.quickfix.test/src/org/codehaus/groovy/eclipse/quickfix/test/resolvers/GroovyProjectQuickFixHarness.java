...
public class GroovyProjectQuickFixHarness extends GroovyProjectTestCase {
     ...
     * @throws Exception
     */
    protected List<IQuickFixResolver> getAllQuickFixResolversForType(IMarker[] markers, ProblemType type, ICompilationUnit unit) throws Exception {
        if (markers != null) {
        ...
        return Collections.<IQuickFixResolver>emptyList();
    }
