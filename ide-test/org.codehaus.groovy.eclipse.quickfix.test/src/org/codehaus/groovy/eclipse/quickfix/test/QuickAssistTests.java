...
public class QuickAssistTests extends EclipseTestCase {
    ...
    public void testExtractToLocalRefactoring_1() throws Exception {
    ...
    public void testExtractToLocalRefactoring_2() throws Exception {
    ...
    public void testExtractToLocalRefactoring_3() throws Exception {
    ...
    public void testExtractToLocalRefactoring_4() throws Exception {
    ...
    public void testExtractToLocalRefactoring_5() throws Exception {
    ...
    public void testExtractToLocalRefactoring_6() throws Exception {
    ...
    public void testExtractToLocalRefactoring_7() throws Exception {
    ...
    public void testExtractToLocalRefactoring_8() throws Exception {
    ...
    public void testExtractToLocalRefactoring_9() throws Exception {
    ...
    public void testExtractToLocalRefactoring_10() throws Exception {
    ...
    public void testExtractToLocalRefactoring_10a() throws Exception {
        assertConversion(ExtractLocalTestsData.getTest10In(),
                ExtractLocalTestsData.getTest10Out(),
                ExtractLocalTestsData.findLocation("model.farInstance() ", "test10"),
                "model.farInstance() ".length(), ExtractToLocalProposal.class);
    ...
    public void testExtractToLocalRefactoring_10b() throws Exception {
        assertConversion(ExtractLocalTestsData.getTest10In(),
                ExtractLocalTestsData.getTest10Out(),
                ExtractLocalTestsData.findLocation("model.farInstance()  ", "test10"),
                "model.farInstance()  ".length(), ExtractToLocalProposal.class);
    ...
    public void testExtractToLocalRefactoring_11() throws Exception {
    ...
    public void testExtractToLocalRefactoring_12() throws Exception {
    ...
    public void testExtractToLocalRefactoring_13() throws Exception {
    ...
    public void testExtractToConstant_1() throws Exception {
    ...
    public void testExtractToConstant_2() throws Exception {
    ...
    public void testExtractToConstant_3() throws Exception {
    ...
    public void testExtractToConstant_4() throws Exception {
    ...
    public void testExtractToConstant_5a() throws Exception {
    ...
    public void testExtractToConstant_6a() throws Exception {
    ...
    public void testExtractToConstant_NoReplaceOccurrences1() throws Exception {
    ...
    public void testExtractToField_MethodToModule() throws Exception {
    ...
    public void testExtractToField_ClosureToModule() throws Exception {
    ...
    public void testExtractToField_DeclarationWithDef() throws Exception {
    ...
    public void testExtractToField_DeclarationWithType() throws Exception {
    ...
    public void testExtractToField_Reference() throws Exception {
    ...
    public void testExtractToField_TupleDeclaration() throws Exception {
    ...
    public void testExtractToField_Initialization() throws Exception {
    ...
    public void testExtractToField_FieldReference() throws Exception {
    ...
    public void testExtractToField_Exception() throws Exception {
    ...
    public void testExtractToField_Prefix() throws Exception {
    ...
    public void testExtractToField_MethodInvocation() throws Exception {
    ...
    public void testExtractToField_ParameterList() throws Exception {
    ...
    public void testExtractToField_ArgumentList() throws Exception {
    ...
    public void testExtractToField_InnerClass() throws Exception {
    ...
    public void testExtractToField_FakeField() throws Exception {
    ...
    public void testExtractToField_ClosureParameterList() throws Exception {
    ...
    private void assertConversion(String original, String expected, String searchFor,
    ...
    private void assertProposalNotOffered(String original, int offset, int length,
        ...
        assertFalse("Expecting that proposals not offered for '" + proposal.getDisplayString() + "'", proposal.hasProposals());
    }
