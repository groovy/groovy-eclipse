...
final class SaveParticipantRegistryTests extends EclipseTestCase {
    ...
    void testInstallUninstallPostSaveCleanUp() {
        ...
        assert listener instanceof DelegatingCleanUpPostSaveListener :
            'Should have found a DelegatingCleanUpPostSaveListener, but instead found ' + listener.class.canonicalName + ' this means that the delegating listener was not installed.'
        ...
        assert listener instanceof CleanUpPostSaveListener :
            'Should have found a CleanUpPostSaveListener, but instead found ' + listener.class.canonicalName + ' this means that the delegating listener was not uninstalled.'
