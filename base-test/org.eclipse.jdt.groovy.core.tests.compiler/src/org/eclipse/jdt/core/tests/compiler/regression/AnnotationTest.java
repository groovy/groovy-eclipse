...
public void test142b() {
	Map<String, String> raiseInvalidJavadocSeverity = new HashMap<String, String>(2);
...
public void test142c() {
	Map<String, String> raiseDeprecationReduceInvalidJavadocSeverity = new HashMap<String, String>(2);
