...
public static void compile(String[] pathsAndContents, Map<String, String> options, String outputPath) {
	compile(pathsAndContents, options, null, outputPath);
}
public static void compile(String[] pathsAndContents, Map<String, String> options, String[] classpath, String outputPath) {
...
public static void createJar(String[] pathsAndContents, Map<String, String> options, String jarPath) throws IOException {
	createJar(pathsAndContents, null, options, null, jarPath);
}
public static void createJar(String[] pathsAndContents, String[] extraPathsAndContents, Map<String, String> options, String jarPath) throws IOException {
	createJar(pathsAndContents, extraPathsAndContents, options, null, jarPath);
}
public static void createJar(String[] pathsAndContents, String[] extraPathsAndContents, Map<String, String> options, String jarPath, String[] classpath) throws IOException {
	createJar(pathsAndContents, extraPathsAndContents, options, classpath, jarPath);
}

public static void createJar(String[] pathsAndContents, String[] extraPathsAndContents, Map<String, String> options, String[] classpath, String jarPath) throws IOException {
...
private static void addJarEntries(String jreDir, String[] jarNames, List<String> paths) {
