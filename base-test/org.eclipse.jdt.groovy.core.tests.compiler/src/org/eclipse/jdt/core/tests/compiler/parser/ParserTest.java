 ...
 */
public void test012() {
	Map<String, String> nls = Collections.singletonMap(
			CompilerOptions.OPTION_ReportNonExternalizedStringLiteral, CompilerOptions.ERROR);
	runNegativeTest(
		true,
		new String[] {
			"X.java",
...
public void test021() {
	...
	Map<String, String> options = Collections.singletonMap(CompilerOptions.OPTION_MaxProblemPerUnit, "10");
	this.runNegativeTest(
		new String[] {
			"X.java",
			buffer.toString()
